...
#Test to make sure get_destination_index works  
...
#Test to make sure get_traveler_location works.
#print(test_destination_index)

attractions = [[] for destination in destinations]

#Test to make sure the list comprehension worked for attractions.
#print(attractions)
...
add_attraction('Shanghai, China', ['Oriental Peral Tower', ['skyscraper', 'viewing deck']])
